...
URL_SCRIPT="https://raw.githubusercontent.com/MauroSupera/gerenciador-updater/refs/heads/main/pt/p3/gerenciador_pt.sh"  # Link para o conteúdo do script no GitHub
...
NUM_AMBIENTES=3 # Número de ambientes que serão configurados.
